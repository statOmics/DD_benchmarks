## Render covid-results.Rmd with input parameters
## ==============================================
...
parser$add_argument("--rmd-file",
    type = "character",
    default = "analysis/covid-sim-results.Rmd",
    help = "RMarkdown file name. Default: \'%(default)s\'."
)
parser$add_argument("--out_file",
    type = "character",
    default = "analysis/covid-sim-results.html",
    help = "Output file name. Default: \'%(default)s\'."
)
parser$add_argument("--use_celltypes",
    type = "character", nargs = "+",
    default = c("class_switched_memory_B_cell_Healthy", "immature_B_cell_Healthy"),
    help = "Celltypes to use. Default: \'%(default)s\'"
)
parser$add_argument("--use_methods",
    type = "character", nargs = "+",
    default = c("bGLM", "edgeR_QP"),
    help = "Methods to use."
)
...
here::i_am(file.path(here_root, "scripts", "04-render-covid-results.R"))
