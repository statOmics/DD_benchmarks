...
## patient. This data is generated by scripts/02-prepare-mock-replicates.R
...
parser$add_argument("-o", "--outfile",
    type = "character",
    default = "data/covid-SCE_list-immature_B_cell_Healthy-sim_replicates-prop_DE-0_01.rds",
...
here::i_am(file.path(here_root, "scripts", "02b-prepare-sim-replicates.R"))
...
if (args$countsimQC) {
    ...
    ct <- sub("^data/covid-SCE_list-(.+)-mock_replicates\\.rds$", "\\1", args$infile)
    ...
    iwalk(out, function(x, i) {
        ...
        out_file <- sprintf("covid-countsimQC-%s-prop_DE-%s.html", i, p)
        ...
        countsimQCReport(
            ...
            description = "Gene-swapping simulation for covid data",
